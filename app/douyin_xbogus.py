"""Vendored from Johnserf-Seed/f2 (Apache-2.0), f2/utils/xbogus.py.

Pure-Python X-Bogus signature generator for Douyin web endpoints.
...
Source: https://github.com/Johnserf-Seed/f2/blob/main/f2/utils/xbogus.py
"""
