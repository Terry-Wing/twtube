"""Vendored from Johnserf-Seed/f2 (Apache-2.0), f2/utils/abogus.py.

Pure-Python a_bogus signature generator (current Douyin standard) for Douyin
web endpoints. Depends on the pure-Python ``gmssl`` package (SM3 hash).
Kept verbatim (minus the __main__ demo) so it can be re-synced with upstream f2
when ByteDance rotates the signature algorithm.
Source: https://github.com/Johnserf-Seed/f2/blob/main/f2/utils/abogus.py
"""
